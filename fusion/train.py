...
config_encoder.intermediate_size = configs['model']['fusion_model']['intermediate_size']
...
config_decoder.num_hidden_layers = configs['model']['fusion_model']['num_layers']
config_decoder.num_attention_heads = configs['model']['fusion_model']['num_heads']
config_decoder.hidden_size = configs['model']['fusion_model']['hidden_size']
config_decoder.intermediate_size = configs['model']['fusion_model']['intermediate_size']
