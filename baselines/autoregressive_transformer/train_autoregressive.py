...
from transformers import GPT2LMHeadModel, GPT2Config, Trainer, TrainingArguments, EarlyStoppingCallback, TrainerCallback
...
# Create the model
model = GPT2LMHeadModel(config=config_decoder)
...
training_args = TrainingArguments(
    output_dir=os.path.join(artifact_folder, "autoregressive_transformer"),
    ...
    logging_steps=100,
    logging_dir=os.path.join(artifact_folder, "autoregressive_transformer", "logs"),
    ...
    run_name="autoregressive_transformer",
    push_to_hub=False
)
