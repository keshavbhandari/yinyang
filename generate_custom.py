...
parser.add_argument("--config", type=str, default=os.path.normpath("/homes/kb658/yinyang/configs/configs_custom.yaml"),
...
def generate(generation_configs, test_file, phrase_refiner_model, phrase_generation_model, phrase_selection_model, write_midi=True):
    ...
    test_phrases = {}
    test_phrases['metadata'] = generation_configs['metadata']
    test_phrases['motif'] = generation_configs['prompt']['phrase_1']
    
    tempo_location = test_phrases['metadata']['tempo']
    tempo_location = {"0":tempo_location}
    key_signature = test_phrases['metadata']['key_signature']
    key_signature = "KS_" + key_signature
    major_or_minor = test_phrases['metadata']['major_or_minor']
    major_or_minor = "MM_" + major_or_minor
    time_signature = test_phrases['metadata']['time_signature']
    time_signature = "TimeSig_" + time_signature
...
if __name__ == "__main__":
    ...
    test_file = "generate_custom.json"
